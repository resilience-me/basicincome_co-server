...
<b>The design of Basicincome.co´s server, right now:<b>
...
basicincome_co.js manages the websocket between client and server

subscribe.js creates the mirror network

dividend_algorithm.js does everything else, and that script is not finished in this repo
